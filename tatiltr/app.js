...
function ensureInitialToggleState() {
  setToggleUI(toggleInfoBtn, infoBodyEl, "Bilgi aç", "Bilgiyi kapat");
  setToggleUI(toggleHolidayListBtn, holidayListEl, "2026 Tatiller aç", "2026 Tatilleri kapat");
